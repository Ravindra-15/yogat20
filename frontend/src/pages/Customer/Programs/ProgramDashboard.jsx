// Zealtho Programs - Program Dashboard
// Daily tracker + video cards page (the "/home" for subscribed users)
// Uses shared CustomerNavbar for consistent auth-aware navigation
